...
import com.example.springserver.api.model.Genre;
import com.example.springserver.api.model.User;
...
public class UserService {
    ...
    public UserService() {
        ...
        userList.add(new User(100, "Johan", List.of(Genre.ACTION), List.of("Dishonored", "Batman"), List.of(2, 3)));
